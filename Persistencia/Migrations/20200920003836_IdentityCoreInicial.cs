    ...
    public partial class IdentityCoreInicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CursosId = table.Column<Guid>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CursosId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comentario", x => x.ComentarioId);
                    table.ForeignKey(
                        name: "FK_Comentario_Cursos_CursosId",
                        column: x => x.CursosId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Precio_Cursos_CursosId",
                        column: x => x.CursosId,
                        principalTable: "Cursos",
                        principalColumn: "CursosId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CursoInstructor", x => new { x.InstructorId, x.CursosId });
                    table.ForeignKey(
                        name: "FK_CursoInstructor_Cursos_CursosId",
                        column: x => x.CursosId,
                        principalTable: "Cursos",
                        principalColumn: "CursosId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Comentario_CursosId",
                table: "Comentario",
                column: "CursosId");

            migrationBuilder.CreateIndex(
                name: "IX_CursoInstructor_CursosId",
                table: "CursoInstructor",
                column: "CursosId");

            migrationBuilder.CreateIndex(
                name: "IX_Precio_CursosId",
                table: "Precio",
                column: "CursosId",
                unique: true);
        }
